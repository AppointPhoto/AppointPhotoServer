...
<div class="row">
  ...
  <div class="eightcol last">
    ...
    <form id="my-form" action="userRegisterAction.action">

        <section name="第一步">

          <div><label>用户名:</label><input id="name" name="name" type="text"/></div>
          <div><label>密码:</label><input id="password" name="password" type="password"/></div>
          <div><label>邮箱:</label><input id="emailAddress" name="emailAddress" data-ideal="required email" type="email"/></div>
